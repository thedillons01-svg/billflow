  ...
  return (
    <div style={{ maxWidth: 700 }}>
      <p style={{ fontSize: 13, color: 'var(--color-text-secondary)', marginBottom: 16, lineHeight: 1.6 }}>
        Rules automatically assign GL accounts to line items based on description text or unit price. Rules are evaluated after stored mappings — if both match, the rule takes priority.
      </p>
